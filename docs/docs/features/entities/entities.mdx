...
const todo$ = todosStore.pipe(selectEntityByPredicate(({completed}) => !completed));
const title$ = todosStore.pipe(selectEntityByPredicate(({completed}) => !completed, {pluck: "title", idKey: "_id"}));
const title$ = todosStore.pipe(selectEntityByPredicate(({completed}) => !completed, {pluck: (e) => e.title, idKey: "_id"}));
```
...
const todos$ = todosStore.pipe(selectManyByPredicate(entity => entity.completed === false));
const titles$ = todosStore.pipe(selectManyByPredicate(entity => entity.completed === false, {pluck: "title"}));
const titles$ = todosStore.pipe(selectManyByPredicate(entity => entity.completed === false, {pluck: (e) => e.title}));
```
...
```ts
import { getEntities } from '@ngneat/elf-entities';
