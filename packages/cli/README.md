...
@ngneat/elf-cli/1.0.0-beta.6 darwin-x64 node-v14.15.4
$ elf --help [COMMAND]
USAGE
  $ elf COMMAND
...
...
_See code: [src/commands/install.ts](https://github.com/ngneat/elf/blob/v1.0.0-beta.6/src/commands/install.ts)_
...
_See code: [src/commands/repo.ts](https://github.com/ngneat/elf/blob/v1.0.0-beta.6/src/commands/repo.ts)_
<!-- commandsstop -->
