...
@ngneat/elf-cli/2.1.0 darwin-x64 node-v14.18.1
$ elf --help [COMMAND]
USAGE
  $ elf COMMAND
...
...
_See code: [lib/commands/install.js](https://github.com/ngneat/elf/blob/v2.1.0/lib/commands/install.js)_
...
_See code: [lib/commands/repo.js](https://github.com/ngneat/elf/blob/v2.1.0/lib/commands/repo.js)_
<!-- commandsstop -->
