...
describe('add', () => {
  ...
  describe('addEntitiesFifo', () => {
    ...
    it('should work', () => {
      const limit = 3;
      store.reduce(addEntitiesFifo([createTodo(1), createTodo(2), createTodo(3)], {limit}));
      ...
      store.reduce(addEntitiesFifo([createTodo(4), createTodo(5), createTodo(6), createTodo(7)], {limit}));
